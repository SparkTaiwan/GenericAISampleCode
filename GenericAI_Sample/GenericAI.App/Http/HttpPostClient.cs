...
{
    // One HttpClient shared by every send. Repeated construction would leak
    // sockets into TIME_WAIT and exhaust the ephemeral port range under
    ...
    internal sealed class HttpPostClient
    {
        ...
        // Takes pre-serialised UTF-8 JSON; ByteArrayContent skips the extra
        // UTF-8 copy StringContent would make.
